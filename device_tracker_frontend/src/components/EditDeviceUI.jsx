      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-4">
          ...
          <motion.button
            type="button"
            onClick={onDelete}
            className="flex-1 bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded-lg shadow-md transition"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
          Delete Device
        ...
        <motion.button
          type="button"
          onClick={onCancel}
          className="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded-lg w-full shadow-md transition"
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
        >
        Cancel
